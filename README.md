Этот репозиторий содержит решение конкурса на платформе Kaggle, занявшее 68 место из 1000 участников(на момент выполнения задания, в этом репозитории есть скриншот таблицы лидеров).
